...
<?php
    ...
    <div class="b-item-hover-action f-center mask">
        <div class="b-item-hover-action__inner">
           <!-- <div class="b-item-hover-action__inner-btn_group">
                <a href="services7.html" class="b-btn f-btn b-btn-light f-btn-light info"><i class="fa fa-link"></i></a>
            </div>-->
        </div>
    </div>
</div>
    <div class="b-blog-preview__content b-diagonal-line-bg-light">
        <div class="b-blog-preview__content-padding_box">
           <p class="f-blog-preview__content-title f-primary-b"><a href="../service1?slug=<?php echo $sel24['slug'];?>"><strong><?php echo $sel24['heading'];?></strong></a></p>
         <?php echo $sel24['descrip'];?>
        </div>
        <div class="b-footer-mini b-alternative-bg">
            <a class="f-footer-mini__link f-more f-primary-b" href="../service1?slug=<?php echo $sel24['slug'];?>"><i class="fa fa-angle-double-right"></i> Overview </a>
        </div>
    </div>
</div>
            </div>
