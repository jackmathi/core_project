...
<?php include'../inc/header.php';?>
  <?php
			$sql21 = "SELECT * FROM in_banner where autoid='IN-Dental'";
...
<div class="b-breadcrumbs f-breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><a href="../services/"><i class="fa fa-angle-left"></i><span> أقسام المركز </span></a></li>
            <li><i class="fa fa-angle-left"></i><span> علاج العصب </span></li>
        </ul>
    </div>
</div>
