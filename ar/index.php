<?php include'../admin/dbc.php'; error_reporting(0);?>
...
<div class="col-md-5">
<h5 class="f-primary-b f-title-big" style="background-color:#FFF; padding:0px; text-align:right; border-radius: 10px 10px 0px 0px; -moz-border-radius: 10px 10px 0px 0px; -webkit-border-radius: 10px 10px 0px 0px; border-bottom: 2px solid #006ead; color:#999;">تحديثات الأخبار</h5>
      ...
      <div class="item active">
       <img src="../admin/<?php echo $row3['image1'];?>" width="458" height="305" alt="Chania">
        ...
        <div class="carousel-caption">
          <h5> <?php echo $row3['descrip1'];?></h5>
          <p><a href="../latestnews">اقرأ المزيد..</a></p>
        </div>
      </div>
	  <?php
            ...
            ?>
      <div class="item">
        <img src="../admin/<?php echo $row['image1'];?>" alt="Chania">
         <br>
        <div class="carousel-caption">
          <h5><?php echo $row3['descrip1'];?></h5>
          <p><a href="../latestnews">اقرأ المزيد..</a></p>
 ...
 <div class="b-some-examples__item f-some-examples__item b-radius-null">
  <?php
		...
		$sel7 = mysql_fetch_array($result26);
            ...
            ?>
  <h5 class="f-primary-b f-title-big"  style="background-color:#fff; padding:0px; text-align:right; color:#666;  border-radius: 10px 10px 0px 0px ;
-moz-border-radius: 10px 10px 0px 0px ;
-webkit-border-radius: 10px 10px 0px 0px ; border-bottom: 2px solid #006ead; color:#999;">أوقات الدوام</h5>
<div class="b-some-examples__item_img b-radius-null b-item-hover-action-parent" style="color:#666; padding:5px; background-color:#FFF;">
  <p style="color:#000; font-size:16px;"> يوم السبت من <a href="#"></a></p>
             <p style="text-align:right; direction:rtl;"><span class="glyphicon glyphicon-time"></span><span class="santime"> <?php echo $sel7['title'];?></span> مساءا </p>
            <p style="color:#000; font-size:16px; line-height:normal"> من الأحد الى الخميس  </a></p>
          <p style="text-align:right; direction:rtl;"><span class="glyphicon glyphicon-time"></span><span class="santime"> <?php echo $sel7['title1'];?></span> ظهرا</p>
             <p style="text-align:right; direction:rtl;"> و من  <span class="santime"><?php echo $sel7['title11'];?></span> مساءا </p>
             <p style="color:#000; font-size:16px;"> يوم الجمعة من </p>
             <p style="text-align:right; direction:rtl;"><span class="glyphicon glyphicon-time"></span>
			 <span class="santime">  <?php echo $sel7['title2'];?></span> مساءا </p>
...
-moz-border-radius: 10px 10px 0px 0px ;
-webkit-border-radius: 10px 10px 0px 0px ;">فيس بوك </h4>
...
-moz-border-radius: 10px 10px 0px 0px ;
-webkit-border-radius: 10px 10px 0px 0px ;">التغريدات</h4>
