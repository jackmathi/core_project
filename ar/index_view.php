...
('null','$name','$email','$phone','$date','$services','$services1','$services2','$services3','$services4','$services5','$services6','$services7','$social','$desc','$page')");
 ...
 <section class="b-full-search" style="background-color:#EBEDF1;">
  ...
  <div class="col-md-6">
    <label class="checkbox-inline"><input type="checkbox" name="services" value="علاج العصب"><span style="padding-right:15px; font-size:13px; color:#FFF;">علاج العصب	</span></label>
    <label class="checkbox-inline"><input type="checkbox" name="services1" value="تقويم الاسنان"><span style="padding-right:15px; font-size:13px; color:#FFF;">تقويم الاسنان</span></label>
    <label class="checkbox-inline"><input type="checkbox" name="services2" value="تنظيف الاسنان"><span style="padding-right:15px; font-size:13px; color:#FFF;">تنظيف الاسنان</span></label>
    <label class="checkbox-inline"><input type="checkbox" name="services3" value="جراحه الاسنان"><span style="padding-right:15px; font-size:13px; color:#FFF;">جراحه الاسنان</span></label></div>
  <div class="col-md-6">
    <label class="checkbox-inline"><input type="checkbox" name="services4" value="حشوات الاسنان"><span style="padding-right:15px; font-size:13px; color:#FFF;">حشوات الاسنان</span></label>
    <label class="checkbox-inline"><input type="checkbox" name="services5" value="تعويضات الاسنان"><span style="padding-right:15px; font-size:13px; color:#FFF;">تعويضات الاسنان</span></label>
