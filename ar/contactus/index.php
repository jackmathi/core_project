<?php include'../../admin/dbc.php'; error_reporting(0);?> <?php include'../inc/header.php';?>
<?php
			$sql21 = "SELECT * FROM in_banner where autoid='IN-Contact'";
...
<div class="b-breadcrumbs f-breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><i class="fa fa-angle-left"></i><span> الاتصال بنا </span></li>
        </ul>
    </div>
</div>
