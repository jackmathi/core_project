  ...
  <div class="container">
    <div class="b-footer-secondary row">
      <div class="col-md-3" style="color:#666; ">
        ...
        <div class="b-some-examples__item_img">
        <img data-retina src="img/add2.jpg"></div>
      ...
      <div class="col-md-4">
        <h4 class="f-primary-b" style="color:#FFF; ">لدينا اتصال</h4>
        <div class="b-contacts-short-item-group">
          <div class="b-contacts-short-item col-md-12 col-sm-4 col-xs-12">
            ...
            <div class="b-remaining f-contacts-short-item__text">
              العليا - طريق الملك فهد<br/>
               <span class="santext1"> 11537</span> ص.ب <span class="santext1"> 68881 </span>الرياض<br/>
               هاتف:<span class="santext1">4643512 - 4644030</span>
<br/>
            </div>
          </div>
          ...
          <div class="b-contacts-short-item col-md-12 col-sm-4 col-xs-12">
            ...
            <div class="b-remaining f-contacts-short-item__text f-contacts-short-item__text_email">
              <a href="mailto:info@esteshari.com.sa"><span class="santext1">info@esteshari.com.sa</span></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5" style="float:right">
        <h4 class="f-primary-b" style="color:#FFF; ">مناطقنا</h4>
...
">
        <div class="row">
            ...
            <div class="col-sm-8 col-xs-12">
                ...
                <nav class="b-bottom-nav f-bottom-nav b-right hidden-xs">
                    <ul>
                        <li class="is-active-bottom-nav"><a href="#">الرئيسية</a>
    <!--index-->
    </li>
    ...
    <li><a href="about/">معلومات عنا</a>
     ...
     <li><a href="service/">أقسام المركز</a>
        <!--about-->
    </li>
