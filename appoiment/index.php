...
/*    var x = document.forms["myForm"]["email"].value;
  ...
  <?php
			$sql21 = "SELECT * FROM in_banner where autoid='IN-Appoiments'";
			$result31 = mysql_query($sql21) or die (mysql_error());
			$sel2 = mysql_fetch_array($result31);
            ?>	
    <div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
  <div class="b-inner-page-header__content" style="background-image:url(../admin/<?php echo $sel2['image1'];?>); background-position:left; background-repeat:no-repeat; background-color:#d7e9f7;">
    <div class="container">
...
<div class="b-breadcrumbs f-breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><i class="fa fa-angle-right"></i><span> Appoiment </span></li>
        </ul>
    </div>
</div>
