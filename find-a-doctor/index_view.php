...
('null','$name','$email','$phone','$date','$services','$services1','$services2','$services3','$services4','$services5','$services6','$services7','$social','$desc','$page')");
 ...
 if($ins_regdetls){
         $EmailSubject = "Find Doctor Form: ".ucfirst($owner);
...
<section class="b-desc-section-container b-diagonal-line-bg-light"  style="background-color:#EBEDF1; padding-bottom:10px;">
 ...
 <div class="b-full-search-form">
           <h4 class="f-right f-primary-b" style="color:#00476f; border-bottom: 1px solid #00476f; padding-bottom:10px; padding-top:10px;">Fix your Appoiments</h4>
  <form name="myForm" action="" enctype="multipart/form-data" method="post">
                    <div class="row">
                        ...
                        <div class="clearfix visible-md visible-sm"></div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                    <div class="b-full-search-form_label f-full-search-form_label f-primary-b">Choose Date</div>
                        ...
                        <div class="clearfix visible-md visible-sm"></div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="b-full-search-form_label f-full-search-form_label f-primary-b">Select services</div>
...
<label class="checkbox-inline"><input type="checkbox" value="زراعة الأسنان" name="services7"><span style="padding-right:15px; font-size:13px; color:#FFF;">زراعة الأسنان</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <textarea class="form-control" placeholder="Message" name="desc" id="desc" rows="3"></textarea>
                                </div>
