...
<head>
	...
	<meta name="author" content="The Esteshari Dental Center ">
...
<body class="">
    ...
    <!--    <a id="rightmenu-trigger" class="tooltips" data-toggle="tooltip" data-placement="left" title="Toggle Infobar"></a>-->
        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="dashboard.php">Halal </a>
        </div>
        <ul class="nav navbar-nav pull-right toolbar">
        	<li class="dropdown">
        		<a href="#" class="dropdown-toggle username" data-toggle="dropdown"><span class="hidden-xs">Admin <i class="fa fa-caret-down"></i></span><img src="assets/demo/avatar/dangerfield.png" alt="Dangerfield" /></a>
        		<ul class="dropdown-menu userinfo arrow">
        			<li class="username">
                        <a href="#">
        				    <div class="pull-left"><img src="assets/demo/avatar/dangerfield.png" alt="Halal"/></div>
        				    <div class="pull-right"><h5>Admin</h5><small>Logged in as <span>6565</span></small></div>
                        </a>
        			</li>
        			<li class="userlinks">
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
				...
				<li><a href="javascript:;"><i class="fa fa-th"></i> <span>Banner</span><span class="badge badge-primary">2</span> </a>
                    <ul class="acc-menu">
						<li><a href="view_banner.php"><span>Home Banner</span></a></li>
						 <li><a href="view_in.php"><span>Inner Banner</span></a></li>
                    </ul>
                </li>
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Home</span><span class="badge badge-primary">5</span> </a>
                    <ul class="acc-menu">
                        <li><a href="view_header.php"><span>Header</span></a></li>
						<li><a href="view_footer.php"><span>Footer</span></a></li>
                        <li><a href="view_offer.php"><span>Latest Offer</span></a></li>
                        <li><a href="view_hours.php"><span>Working Hours  </span></a></li>
                        <li><a href="view_blog.php"><span>Our Blog </span></a></li>
                    </ul>
                </li>
				 <li><a href="view_about.php"><i class="fa fa-list-ol"></i> <span>About Us </span>
				 <span class="badge badge-indigo"></span><span class="badge badge-primary"></span> </a>
                  
                </li>
				
				<li><a href="javascript:;"><i class="fa fa-pencil"></i> <span>Service </span><span class="badge badge-primary">2</span></a>
                    <ul class="acc-menu">
                        <li><a href="view_title.php">Sub Menu</a></li>
						<li><a href="view_service.php">Service</a></li>
                    </ul>
                </li>
                <li><a href="view_news.php"><i class="fa fa-pencil"></i> <span>Latest News</span><span class="badge badge-primary"></span></a>
                </li>
            </ul>
            <!-- END SIDEBAR MENU -->
        </nav>
