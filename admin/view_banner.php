...
<tbody>
<?php
$sql2 = "SELECT * FROM banner where page='banner' order by id DESC";
...
<td class="center"><a href="view_banner.php?status=stus&id=<?php echo $sel['autoid'];?>&activeid=<?php echo $sel['status'];?>" class="buttn">
...
<td>
<a href="update_banner.php?autoid=<?php echo $sel['autoid'];?>" class="btn btn-orange">Edit</a>
<a href="view_banner.php?delete=d&id=<?php echo $sel['id']; ?>"onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-inverse">Delete</a></td>
</td>
<?php } ?>
</tr>
</tbody>
