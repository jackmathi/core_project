...
error_reporting (0);
  ...
  if($_GET['status']=="stus"){
		  ...
		  if($status==0){
 	$update_status = mysql_query("update service set status=1 where autoid='$id' and status='$status'");
		  }
		  else
		  {
 	$update_status = mysql_query("update service set status=0 where autoid='$id' and status='$status'");
		  }
				}
...
<div id="page-content">
            ...
            <div class="options">
                <div class="btn-toolbar">
                    <div class="btn-group hidden-xs">
                       <a href="add_service.php" class="btn btn-magenta">Add Service</a>
  ...
  $sql2 = "SELECT * FROM service where page='service' order by id DESC";
	...
	?>
                                    ...
                                    <tr class="odd gradeX">
										...
										<td><?php echo $sel['title1'];?> </td>
										   ...
										   <td class="center"><a href="view_service.php?status=stus&id=<?php echo $sel['autoid'];?>&activeid=<?php echo $sel['status'];?>" class="buttn">
			...
			<a href="update_service.php?autoid=<?php echo $sel['autoid'];?>" class="btn btn-orange">Edit</a>
			<a href="view_service.php?delete=d&id=<?php echo $sel['id']; ?>"onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-inverse">Delete</a></td>
                                  </td>
