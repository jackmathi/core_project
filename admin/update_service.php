...
if($_POST['Submit'] == 'Update') 	
    ...
    mysql_query("UPDATE `service` SET `title`='$title',`title1`='$title1',`descrip`='$descrip',`descrip1`='$descrip1',`order_1`='$order_1'  WHERE autoid ='$id'");
				...
				mysql_query("UPDATE `service` SET `image1` = '$upload_pic' WHERE `autoid` ='$id'");
				}
				
	header('Location:view_service.php?msg=1');
		}
?>
				...
				<div class="col-sm-12">
				  <div class="panel panel-primary">
				      ...
				      <div class="panel-body">
				      	 <?php 
		  $autoid = $_GET['autoid'];
		    $rs_settings = mysql_query("select * from service where autoid='$autoid'");?>
          <?php $row_settings = mysql_fetch_array($rs_settings); ?>
						<form class="form-horizontal"  enctype="multipart/form-data" method="post">
						    ...
						    <div class="col-xs-6">
							 ...
							 <input type="text" name="heading" class="form-control" value="<?php echo $row_settings['heading']; ?>" readonly>
						    </div>
						   
						  </div>
						  
						  						   <div class="form-group">
						    <label for="focusedinput" class="col-sm-3 control-label">Arabic Sub Menu</label>
						    <div class="col-xs-6">
							
							 <input type="text" name="heading1" class="form-control" value="<?php echo $row_settings['heading1']; ?>" readonly>
						    </div>
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
						    <label for="focusedinput" class="col-sm-3 control-label">Arabic Child Menu</label>
						    <div class="col-xs-6">
