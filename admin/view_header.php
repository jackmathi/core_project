...
if($_POST['Submit'] == 'Update') 	
			...
			$mail1=$_POST['mail1'];
			$phone=$_POST['phone'];
    mysql_query("UPDATE `header` SET `mail1`='$mail1',`phone`='$phone'  WHERE autoid ='$id'");
	...
	header('Location:view_header.php?msg=1');
		}
?>
				...
				<div class="col-sm-12">
				  <div class="panel panel-primary">
				      ...
				      <div class="panel-body">
				      	 <?php 
		    $rs_settings = mysql_query("select * from header where autoid='H-1'");?>
          <?php $row_settings = mysql_fetch_array($rs_settings); ?>
						<form class="form-horizontal"  enctype="multipart/form-data" method="post">
						  <div class="form-group">
						    ...
						    <div class="col-xs-6">
						     <input type="text" name="phone" class="form-control" value="<?php echo $row_settings['phone']; ?>" >
						    </div>
						  </div>
						      <div class="form-group">
